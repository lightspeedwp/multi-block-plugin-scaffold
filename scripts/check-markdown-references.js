...
if ( issues.length ) {
	console.log( 'Found .instructions.md references inside References/See Also sections:\n' );
	...
	issues.forEach( ( issue ) => {
		...
		console.log(
			`  Line ${ issue.line } (${ issue.section }): ${ issue.text }`
		);
	} );

	console.log( `\nTotal references found: ${ issues.length }` );
} else {
	console.log( 'No third-party instructions references were found in References/See Also sections.' );
}
