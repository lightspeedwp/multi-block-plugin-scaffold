...
const schemaPath = path.join(__dirname, '../../.github/instructions/block-json.schema.json');
let blockJsonSchema;
try {
...
describe('Block JSON schema validation', () => {
  const blockJsonFiles = glob.sync(path.join(__dirname, '../../src/blocks/**/block.json'));
