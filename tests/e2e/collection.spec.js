/**
 * E2E tests for Example Plugin Collection block.
 *
 * @package
 */
...
test.describe('Example Plugin Collection Block', () => {
	...
	test('should insert collection block', async ({ page }) => {
		...
		const blockItem = page.locator(
			'.block-editor-block-types-list__item[data-id="example_plugin/example-plugin-collection"]'
		);
