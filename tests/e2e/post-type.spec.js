/**
 * E2E tests for Example Plugin Post Type.
 *
 * @package
 */
...
test.describe('Example Plugin Post Type', () => {
	...
	test('should have post type menu item', async ({ page }) => {
		...
		const menuItem = page.locator('#menu-posts-example-plugin');
		await expect(menuItem).toBeVisible();
	});

	test('should create new post', async ({ page }) => {
		// Navigate to add new post.
		await page.goto('/wp-admin/post-new.php?post_type=example-plugin');
	...
	test('should list posts', async ({ page }) => {
		...
		await page.goto('/wp-admin/edit.php?post_type=example-plugin');
