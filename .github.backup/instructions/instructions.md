...
- [folder-structure.instructions.md](./folder-structure.instructions.md) — Repository folder organization and file placement rules
- [generate-plugin.instructions.md](./generate-plugin.instructions.md) — Mustache template system rules
- [scf-fields.instructions.md](./scf-fields.instructions.md) — SCF field types and best practices
- [theme-json.instructions.md](./theme-json.instructions.md) — Theme.json configuration rules
