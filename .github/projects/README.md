...
1. **Planning Phase**
   ...
   - [ ] Create file in `.github/projects/active/`
   - [ ] Use template format above
   - [ ] Commit: `git add .github/projects/active/filename.md && git commit -m "project: add task list for [project]"`
...
- ✅ Create in `.github/projects/active/` directory (NOT root, NOT docs/)
...
1. Create the file in .github/projects/active/ (NOT root)
...
touch .github/projects/active/MY-PROJECT-TASKS.md

# Add frontmatter and structure
# See template above

# Commit
git add .github/projects/active/MY-PROJECT-TASKS.md
...
```bash
# Move to completed
mv .github/projects/active/MY-PROJECT-TASKS.md .github/projects/completed/
