...
# Run chain analysis
node scripts/audit-frontmatter.js --summary
```
...
- [ ] **Execute audit script** (2 mins)
  ...
  ```bash
  node scripts/audit-frontmatter.js --summary > docs/CHAIN-AUDIT-FINAL.md
  ```
...
- [ ] **Final validation** (5 mins)
  ...
  - Run chain audit: `node scripts/audit-frontmatter.js`
